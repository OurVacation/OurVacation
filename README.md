...
## 🙋‍♂️ About Me
**"시스템의 근본 원리를 파고드는 예비 인프라 엔지니어"**

현재 **인프라 및 클라우드(Infra & Cloud)** 분야 취업을 목표로 달리고 있습니다.
로우 레벨(Low-level) 언어에 대한 깊은 이해를 바탕으로, 안정적이고 효율적인 서버 환경을 구축하는 데 관심이 많습니다.

- 🎓 **42 Gyeongsan**에서 C와 C++을 통해 CS 기초와 시스템 프로그래밍 역량을 다지고 있습니다.
- 🦀 **Rust**의 메모리 안전성과 성능에 매료되어, The Book기반 스터디 및 프로젝트를 진행 중입니다.
- ☁️ 시스템 아키텍처와 클라우드 인프라 구축 기술을 꾸준히 익혀나가고 있습니다.
